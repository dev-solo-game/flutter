...
class WindowingOwnerWin32 extends WindowingOwner {
  ...
  TooltipWindowController createTooltipWindowController({
    ...
    throw UnimplementedError(
      'Tooltip windows are not yet implemented on Windows.',
    );
  }
...
class RegularWindowControllerWin32 extends RegularWindowController {
  ...
  Offset get position {
    ...
    final result = Offset(bounds.x, bounds.y);
    return result;
  }
  ...
  void fullOnMonitors() {
    _ensureNotDestroyed();
    _Win32PlatformInterface.fullOnMonitors(getWindowHandle());
  }
...
class _Win32PlatformInterface {
  ...
  static int createRegularWindow(
    ...
    try {
      ...
      request.ref.initialPosition.from(initPosition);
  ...
  @ffi.Native<ffi.Void Function(HWND)>(
    symbol: 'InternalFlutterWindows_WindowManager_FullOnMonitors',
  )
  external static void fullOnMonitors(HWND windowHandle);
  //--------------------
...
final class _RegularWindowCreationRequest extends ffi.Struct {
  external _WindowPositionRequest initialPosition;
